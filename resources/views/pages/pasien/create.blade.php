@extends('layouts.app', ['title' => __('Buat Pasien')])

@section('content')
    @include('users.partials.header', [
        'title' => __('Buat Pasien'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        {{-- <div class="row align-items-center"> --}}
                            <h3 class="mb-2">{{ __('Buat Pasien') }}</h3>
                        {{-- </div> --}}
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('pasien.post') }}" autocomplete="off">
                            @csrf
                            @method('post')
                            @if (session('status'))
                            ...
                            <div class="pl-lg-4">
                                <div class="d-flex justify-content-around">
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('nama_lengkap') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama_lengkap" id="input-gol-darah" class="form-control form-control-alternative{{ $errors->has('nama_lengkap') ? ' is-invalid' : '' }}" placeholder="{{ __('Nama') }}" required>
                                    ...
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('nik') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="nik" name="nik" id="input-nik" class="form-control form-control-alternative{{ $errors->has('nik') ? ' is-invalid' : '' }}" placeholder="{{ __('NIK') }}" required>
                                ...
                                <div class="d-flex justify-content-around">
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="golongan_darah" id="input-gol-darah" class="form-control form-control-alternative{{ $errors->has('golongan-darah') ? ' is-invalid' : '' }}" placeholder="{{ __('Golongan Darah') }}" required>
                                    ...
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('alamat') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="alamat" id="input-alamat" class="form-control form-control-alternative{{ $errors->has('alamat') ? ' is-invalid' : '' }}" placeholder="{{ __('Alamat') }}" required>
                                ...
                                <div class="d-flex justify-content-start">
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('usia') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="usia" id="input-usia" class="form-control form-control-alternative{{ $errors->has('usia') ? ' is-invalid' : '' }}" placeholder="{{ __('Usia') }}" required>
                                ...
                                <div class="d-flex justify-content-around">
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('harga-obat') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="harga_obat" id="input-harga-obat" class="form-control form-control-alternative{{ $errors->has('harga-obat') ? ' is-invalid' : '' }}" placeholder="{{ __('Rp. 00') }}">
                                    ...
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('tanggal-lahir') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="harga_tindakan" id="input-harga-tindakan" class="form-control form-control-alternative{{ $errors->has('harga-tindakan') ? ' is-invalid' : '' }}" placeholder="{{ __('Rp. 00') }}" required>
                                ...
                                <div class="d-flex justify-content-start">
                                    <div class="form-group p-1 col-lg-6 {{ $errors->has('harga-lab') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="harga_lab" id="input-harga-lab" class="form-control form-control-alternative{{ $errors->has('harga-lab') ? ' is-invalid' : '' }}" placeholder="{{ __('Rp. 00') }}">
