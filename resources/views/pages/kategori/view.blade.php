...
@section('content')
    @include('users.partials.header', [
        'title' => __('Detail Kategori Penyakit'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        {{-- <div class="row align-items-center"> --}}
                            <h3 class="mb-2">{{ __('Detail Kategori Penyakit') }}</h3>
                        {{-- </div> --}}
                    </div>
                    <div class="card-body">
                            ...
                            <div class="pl-lg-4">
                                <div class="d-flex justify-content-around">
                                    <div class="form-group p-1 col-lg-12{{ $errors->has('nama_penyakit') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama_penyakit" id="input-nama-penyakit" value="{{$jenis_penyakit->nama_penyakit}}" class="form-control  form-control-alternative" disabled>
                                ...
                                <div class="d-flex justify-content-around">
                                    <div class="form-group p-1 col-lg-12{{ $errors->has('kategori') ? ' has-danger' : '' }}">
                                        ...
                                        <select class="form-control form-control-alternative" name="kategori" id="input-kategori" disabled>
                                ...
                                <div>
                                    <a href="{{route('kategori.index')}}" class="btn btn-danger mt-4">{{ __('Kembali') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
